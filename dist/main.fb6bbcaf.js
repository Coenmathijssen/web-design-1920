...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/subtitles.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.startSubtitles = startSubtitles;

var _gsap = require("gsap");

function startSubtitles() {
  var tlSubtitles = _gsap.gsap.timeline();

  tlSubtitles.to('#s01', 0, {
    opacity: 1
  }, 9).to('#s01', 0, {
    opacity: 0
  }, 10.5).to('#s02', 0, {
  ...
  var tlAnimationBeep = _gsap.gsap.timeline();

  tlAnimationBeep.to('.beeping-monitor-container', 0, {
    opacity: 1
  }, 9).to('.beeping-monitor-container', 0, {
    opacity: 0
  }, 65);

  var tlAnimationSteps = _gsap.gsap.timeline(); // Footsteps


  tlAnimationSteps.to('.footsteps-container', 0, {
    opacity: 1
  }, 35).to('#footstep-top-1', 0.3, {
    opacity: 1
  }, 35).to('#footstep-bottom-1', 0.3, {
    opacity: 1
  }, 35.4).to('#footstep-top-1', 0.3, {
    opacity: 0
  }, 35.8).to('#footstep-top-2', 0.3, {
    opacity: 1
  }, 36.2).to('#footstep-bottom-1', 0.3, {
    opacity: 0
  }, 36.6).to('#footstep-bottom-2', 0.3, {
    opacity: 1
  }, 38).to('#footstep-top-2', 0.3, {
    opacity: 0
  }, 38.4).to('#footstep-top-3', 0.3, {
    opacity: 1
  }, 38.8).to('#footstep-bottom-2', 0.3, {
    opacity: 0
  }, 39.2).to('#footstep-bottom-3', 0.3, {
    opacity: 1
  }, 39.6).to('#footstep-top-3', 0.3, {
    opacity: 0
  }, 39.9).to('#footstep-bottom-3', 0.3, {
    opacity: 0
  }, 39.9).to('.footsteps-container', 0, {
    opacity: 0
  }, 40.5);
  tlAnimationSteps.to('.footsteps-container', 0, {
    opacity: 1
  }, 65).to('#footstep-top-1', 0.3, {
    opacity: 1
  }, 65).to('#footstep-bottom-1', 0.3, {
    opacity: 1
  }, 65.2).to('#footstep-top-1', 0.3, {
    opacity: 0
  }, 65.4).to('#footstep-top-2', 0.3, {
    opacity: 1
  }, 65.6).to('#footstep-bottom-1', 0.3, {
    opacity: 0
  }, 65.8).to('#footstep-bottom-2', 0.3, {
    opacity: 1
  }, 66).to('#footstep-top-2', 0.3, {
    opacity: 0
  }, 66.2).to('#footstep-top-3', 0.3, {
    opacity: 1
  }, 66.4).to('#footstep-bottom-2', 0.3, {
    opacity: 0
  }, 66.6).to('#footstep-bottom-3', 0.3, {
    opacity: 1
  }, 66.8).to('#footstep-top-3', 0.3, {
    opacity: 0
  }, 67).to('#footstep-bottom-3', 0.3, {
    opacity: 0
  }, 67).to('.footsteps-container', 0, {
    opacity: 0
  }, 67.2);
  ...
  tlAnimationDoor.to('.back-door', 0, {
    ...
    opacity: 1,
    delay: 100.5
  }, 0.3, 1.2).to('#knock-door', 0, {
    opacity: 0
  }, 103).to('.knock', 0, {
    opacity: 0
  }, 103).to('#knock-door-2', 0, {
    opacity: 1
  }, 108).staggerTo('.knock-2', 1.2, {
    opacity: 1,
    delay: 107.5
  }, 0.3, 1.2).to('#knock-door-2', 0, {
    opacity: 0
  }, 110).to('.knock-2', 0, {
    opacity: 0
  }, 110);
